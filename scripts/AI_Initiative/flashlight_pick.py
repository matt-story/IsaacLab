...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/AI_Initiative/flashlight_pick.py --num_envs 16
...
from isaaclab_tasks.manager_based.manipulation.lift_AI_Initiative.lift_env_cfg import LiftEnvCfg
