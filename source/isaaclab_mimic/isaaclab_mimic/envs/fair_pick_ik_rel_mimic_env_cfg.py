...
@configclass
class FAIRPickIKRelMimicEnvCfg(FrankaCubeStackEnvCfg, MimicEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "demo_src_pick_FAIR_lab_task_D0"
        ...
        subtask_configs.append(
            SubTaskConfig(
                ...
                next_subtask_description="Lift object",
            )
        )
