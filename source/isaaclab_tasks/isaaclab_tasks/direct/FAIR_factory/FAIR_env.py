...
from . import FAIR_control as fc
from .FAIR_env_cfg import OBS_DIM_CFG, STATE_DIM_CFG, FAIREnvCfg
...
class FAIREnv(DirectRLEnv):
    cfg: FAIREnvCfg

    def __init__(self, cfg: FAIREnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _init_tensors(self):
        ...
        elif self.cfg_task.name == "flashlight":
            held_base_z_offset = 0.0
    ...
    def _get_curr_successes(self, success_threshold, check_rot=False):
        ...
        if self.cfg_task.name == "peg_insert" or self.cfg_task.name == "gear_mesh" or self.cfg_task.name == "flashlight":
